# -*- coding: utf-8 -*-
#
# Albedo documentation build configuration file, created by
# sphinx-quickstart on Mon Jun  3 12:45:13 2013.
#
...
# theCode here is a placeholder for this directory
sys.path.insert(0, os.path.abspath('theCode'))
sys.path.insert(0, os.path.abspath('.'))

# -- General configuration -----------------------------------------------------
#mathjax_path = 'https://d3eoax9i5htok0.cloudfront.net/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML'
#jsmath_path = 'jsMath/jsMath-3.6e/easy/load.js'
...
#html_theme_options = { googleanalytics_id: XXX }
...
latex_documents = [
  ('index', 'albedo.tex', u'Albedo Documentation',
   'manual'),
]
...
man_pages = [
    ('index', u'Albedo Documentation', 1)
]
...
epub_title = u'Albedo '
epub_author = u'plewis'
epub_publisher = u'plewis'
epub_copyright = u'2013, plewis'
